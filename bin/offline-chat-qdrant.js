...
exports.OfflineChatQdrantService = void 0;
...
// ========================================
class OfflineChatQdrantService {
    constructor(qdrantRepo, embeddings, chatModel = 'gemma3:4b') {
...
6. Use plain text format without markdown formatting (no asterisks, bullets, or special symbols)`;
    ...
    // AI QUERY BUILDER
    // ========================================
    async buildQueryFromNaturalLanguage(userMessage) {
...
exports.OfflineChatQdrantService = OfflineChatQdrantService;
// ========================================
...
//# sourceMappingURL=offline-chat-qdrant.js.map